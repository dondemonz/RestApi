...
# Не забывать, что у пользователя должны быть проставлены права на УС, не смог разобраться как поставить юзеру определенные права (иконка короны, например)
# На УС должна быть камера с  id 1
